...
COMPRESSED_EXTS = [MKV_EXT, MKA_EXT, FLAC_EXT]
UNCOMPRESSABLE_EXTS = [DV_EXT, ISO_EXT, TAR_EXT]
UNCOMPRESSED_EXTS = [MOV_EXT, WAV_EXT]
...
JSON_SUBTYPES = {
    ...
    "video": (set([PM_DIR, SC_DIR, IM_DIR]),
        set([JSON_EXT, MOV_EXT, MKV_EXT, DV_EXT, MP4_EXT, JPEG_EXT, JPG_EXT, GZ_EXT, SRT_EXT, SCC_EXT, ISO_EXT])),
